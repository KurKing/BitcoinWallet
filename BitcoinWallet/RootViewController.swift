...
class RootViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            btcLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 20),
            ...
            transactionsVC.view.topAnchor.constraint(equalTo: button.bottomAnchor, constant: 24),
